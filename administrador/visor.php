...
include_once("partials/header.php");
 ...
 <center><a href="gallery.php"><button class="btn btn-primary" style="margin-top:20px; margin-bottom: 30px;">Regresar</button></a></center>
...
var album_id = $("body").attr("id");
      $.ajax({
            ...
            data: { peticion: 55 , album_id:album_id } // Datos que se envían
