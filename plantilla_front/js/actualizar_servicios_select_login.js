   ...
   $("#cedula").text("0")
    ...
    estado_documento = 1;
            ...
            $.ajax({
                ...
                $("#sel-tipo-documento").val("1");
                 $("#sel-tipo-documento").attr("disabled","disabled");
...
estado_documento = 1;
 ...
 estado_telefono = 1;
    ...
    $("#procesar").click(function () {
        ...
        if (estado_cliente == 1 && estado_documento == 1 && estado_correo == 1 && estado_telefono == 1 && estado_acepto == 1) {
...
var cedula = $("#documento").val();
                     ...
                     $.ajax({
                        ...
                        var elemento = document.getElementById("enlace_click");
   ...
   $(elemento).click();
                ...
                alert("Has creado una Reservación");
