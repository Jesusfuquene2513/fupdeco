$(document).ready(function(){
    ...
    $("#portafolio").click(function(){
        window.location.href ="../../index.php/portafolio";
    });
    ...
    cargar_departamentos();
        function cargar_departamentos(n) {
            $.ajax({
                type: "POST",
                url: "../../index.php/Footer/cargar_departamentos",
                data: {
                    peticion: 27,
        ...
        $("#sel-departamento").change(function(){
            ...
            if(value > 0){
                ...
                $.ajax({
                type: "POST",
                url: "../../index.php/Footer/cargar_municipios",
                data: {
                    departamento: value
...
$("#documento").removeAttr("disabled");
        ...
        $("#enviar-peticion-contacto").click(function() {
           if( $("#nombre_contacto").val().length > 0 && $("#consulta").val().length > 0 && $("#documento").val().length > 0 && $("#telefono").val().length > 0 && $("#correo").val().length > 0 && validar_municipio == 1 ){
